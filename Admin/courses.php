...
if (isset($_POST['submit'])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["thumbnail"]["tmp_name"], $target_file)) {
            ...
            $_SESSION['success_img'] = 'Course has been upload successfully';
        ...
        <?php } else { ?>
            ...
            <div class="card">
                <div class="header py-2">
                    ...
                    <div class="card-tools" style="text-align-last: right;">
                    ...
                    <div class="table-responsive bg-white">
                        <table class=" table table-bordered">
                            ...
                            <tbody>
                                <?php
                                $count = 1;
                                $clourse_query = mysqli_query($db_conn, 'SELECT * FROM courses');
                                while ($course = mysqli_fetch_object($clourse_query)) { ?>
                                    <tr>
                                        <td><?= $count++ ?></td>
